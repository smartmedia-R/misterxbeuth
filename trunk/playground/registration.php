...
<script type="text/javascript" src="js/registration/main.js"></script>
...
<body>
	<div id="wrapper">
		...
		<form id="form" method="post">
			...
			<div id="button_form">
                    <input id="buttons" name="backToLogin" type="button" size="20" onclick="window.location.href='index.html';" value="Zurück zum Login" />
